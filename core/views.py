        ...
        try:
            ...
            if form.is_valid():
                ...
                if same_billing_address:
                    ...
                    billing_address.addresss_type = 'B'
                    billing_address.save()
                    ...
                    print("User is entereing a new billing address.")
...
class PaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            messages.warning(self.request,
                             "You did not add a billing address.")
            return redirect("core:checkout")
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            messages.warning(self.request, 'Not autenticated.')
            return redirect('/')
            ...
            messages.warning(
                self.request,
                'Something went wrong. You were not charge, please try again.')
            return redirect('/')

        except Exception as e:
            messages.error(self.request,
                           'Serious error occur, we have been notified.')
            return redirect('/')
...
def get_coupon(request, code):
    try:
        ...
        return rediretct("core:checkout")
